...
public class StudentListRunner
{
    public static void main (String[] args)
    {
        ...
        while (control != -1) { 
            ...
            if (control == 10)
            {
                System.out.print ("Enter the student ID of the student you would like to find: ");
                list.binarySearch(scr.nextInt());
                String clr = scr.nextLine();
            }
    ...
    public static int menuNumber()
    {
        ...
        menu[9] = "Use binary search to find student (by ID number)";
